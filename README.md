...
**Hello React Front End** is a React on Rails project where i integrated ruby API endpoints inside my react code.
...
[Back End Part](https://github.com/Felipe-Perez-Ferraro/hello-rails-backend)
...
Feel free to check the [issues page](https://github.com/Felipe-Perez-Ferraro/hello-react-front-end/issues).
